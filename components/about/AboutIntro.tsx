          ...
          <IntroWrapper>
            ...
            <Column>
              <IntroSubText className='one'>
                {`프로젝트 성공을 위한 모든 과정을 함께했습니다.`}
              </IntroSubText>
              <br />
              <IntroSubText className='two'>
                {`1. 사용자의 요구사항을 탐색하고, 문제현상을 정의하여 솔루션을 도출합니다.`}
              </IntroSubText>
              <br />
              <IntroSubText className='three'>
                {`2. 필요한 도구들을 수집하고 모델의 설계와 개발 공수를 측정하여 타임라인을 구축합니다.`}
              </IntroSubText>
              <br />
              <IntroSubText className='four'>
                {`3. 사용자 경험에 집중한 심플한 초기 모델을 디자인합니다.`}
              </IntroSubText>
              <br />
              <IntroSubText className='five'>
                {`4. 애자일 방법을 추구합니다. 커뮤니케이션과 PR문화를 중요하게 생각합니다. 일관된 코드를 사용하고, 읽기 쉬운 코드를 짜기위해 고민합니다.`}
              </IntroSubText>
              <br />
              <IntroSubText className='six'>
                {`5. 배포 후 사용자 데이터를 측정하여 발견된 문제 현상을 기반으로 기획을 반복합니다.`}
              </IntroSubText>
            </Column>
          </IntroWrapper>
        )}
